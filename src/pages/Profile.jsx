                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="font-medium text-gray-900">Reliability Planning</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {progress.completedChallenges >= 1 && (
                      <div className="flex items-center space-x-3 p-4 bg-success-50 rounded-lg">
                        ...
                        <div>
                          <p className="font-medium text-gray-900">Reliability Analysis Master</p>
                    ...
                    {progress.completedChallenges >= 2 && (
                      <div className="flex items-center space-x-3 p-4 bg-success-50 rounded-lg">
                        <SafeIcon icon={FiAward} className="w-8 h-8 text-success-600" />
                        <div>
                          <p className="font-medium text-gray-900">Collaboration Expert</p>
                    ...
                    {progress.completedChallenges >= 3 && (
                      <div className="flex items-center space-x-3 p-4 bg-success-50 rounded-lg">
                        <SafeIcon icon={FiAward} className="w-8 h-8 text-success-600" />
                        <div>
                          <p className="font-medium text-gray-900">Context Adaptation Specialist</p>
                    ...
                    {progress.completedChallenges >= 4 && (
                      <div className="flex items-center space-x-3 p-4 bg-success-50 rounded-lg">
                        <SafeIcon icon={FiAward} className="w-8 h-8 text-success-600" />
                        <div>
                          <p className="font-medium text-gray-900">Work Package Enhancement Pro</p>
                    ...
                    {progress.completedChallenges === progress.totalChallenges && (
                      <div className="md:col-span-2 flex items-center space-x-3 p-4 bg-gradient-to-r from-primary-50 to-success-50 rounded-lg border-2 border-primary-200">
                        ...
                        <div>
                          <p className="font-bold text-lg text-gray-900">Certified Reliability Navigator</p>
                          <p className="text-sm text-gray-600">Mastered all reliability planning principles</p>
                        </div>
                      </div>
                    )}
                  </div>
