        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8"> 
          ...
          <div className="lg:col-span-2"> 
            <motion.div 
              ...
              transition={{delay: 0.3,duration: 0.5}} 
            > 
              <h2 className="text-2xl font-bold text-gray-900 mb-2">Project Management Integration Challenges</h2> 
              <p className="text-gray-600"> 
            ...
            > 
              ...
              <div className="space-y-2 text-sm text-primary-700"> 
                <p>• Complete challenges in order - each builds on project management integration fundamentals</p> 
                ...
                {progress.completedChallenges < 4 && ( 
                  <p className="font-semibold"> 
                    • Next: Complete Challenge {progress.completedChallenges + 1} to unlock {progress.completedChallenges + 1 === 4 ? 'your certificate' : `Challenge ${Math.min(progress.completedChallenges + 2, 4)}`}
                  </p> 
                )} 
                {progress.completedChallenges===4 && ( 
                  <p className="font-semibold text-success-700">• All challenges complete - generate your Project Manager Navigator Expert certificate!</p> 
                )} 
              </div> 
            </motion.div> 
          </div> 
