...
export const useProgress = () => {
  ...
  const loadProgress = () => {
    try {
      ...
      if (stored) {
        ...
        localStorage.setItem('projectManagerNavigatorProgress', JSON.stringify(defaultProgress))
      }
    } catch (error) {
  ...
  const saveProgress = (progressData) => {
    try {
      ...
      localStorage.setItem('projectManagerNavigatorProgress', JSON.stringify(progressData))
      setProgress(progressData)
    } catch (error) {
